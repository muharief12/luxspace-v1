...
@section('content')
    ...
    <div class="flex flex-wrap my-4 md:my-12">
        <div class="w-full md:hidden px-4">
            ...
            <span class="text-xl">Rp{{ $product->price }}</span>
        </div>
        <div class="flex-1">
        <div class="slider">
            <div class="thumbnail">
            ...
            <div class="item rounded-lg h-full overflow-hidden">
                <img
                src="{{ $product->galleries()->exists() ? Storage::url($product->galleries->first()->url) : asset('/frontend/images/content/image-arrived-1.png') }}"
                alt="front"
                class="object-cover w-full h-full rounded-lg"
                />
            </div>
        ...
        <h2 class="text-5xl font-semibold"> {{ $product->name }} </h2>
        <p class="text-xl" style="margin-top: 10px">Rp {{ $product->price }}</p>
        ...
        <h6 class="text-2xl font-semibold mb-4">About the product</h6>
        ...
        <div class="px-3 flex-none" style="width: 320px">
            <div class="rounded-xl p-4 pb-8 relative bg-white">
                <div class="rounded-xl overflow-hidden card-shadow w-full h-36">
                    <img
                    src="{{ $recommendation->galleries()->exists() ? Storage::url($recommendation->galleries->first()->url) : asset('/frontend/images/content/image-arrived-1.png') }}"
                    alt=""
