                ...
                <form action="{{ route('dashboard.user.update', $item->id)}}" method="post" class="w-full" enctype="multipart/form-data">
                    ...
                    <div class="flex flex-wrap -mx-3 mb-6">
                        ...
                        <div class="w-full px-3 mb-6">
                            ...
                            <input disabled type="text" value="{{ old('email') ?? $item->email }}" name="email" placeholder="User Email" class="block w-full bg-gray-400 text-white border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500">
                        </div>
                        <div class="w-full px-3 mb-6">
                            <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">
                                Role
                            ...
                            <select name="roles" class="block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500">
                                ...
                                <option disabled style="display:block">-----------</option>
