...
<header class="{{ \Route::current()->getName() == 'index' ? 'absolute' : '' }} w-full z-50 px-4">
    <div class="container mx-auto py-5">
        ...
        <div class="w-auto">
            <ul
            class="fixed bg-white inset-0 flex flex-col invisible align-middle items-center justify-center opacity-0 md:visible md:flex-row md:bg-transparent md:relative md:opacity-100 md:flex md:items-center"
            id="menu"
            >
                ...
                @auth
                    ...
                    >
                        <a
                            ...
                            class="bg-pink-400 text-black hover:bg-black hover:text-pink-400 rounded-full px-3 py-3 mt-4 inline-block flex-none transition duration-200"
                        >
                            Dashboard
                        </a>
                    </li>
